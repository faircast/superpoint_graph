...
def get_info(args):
    ...
    return {
        ...
        'classes': 6,
        'inv_class_map': {0:'other', 1:'ceiling', 2:'floor', 3:'wall', 4:'window', 5:'door'},
    }
    ...
    for n in range(1,7):
        ...
        for file in os.listdir(pathC):
            ...
            if file.endswith(".h5"):
                ...
                P = np.concatenate([xyz, elpsv, xyzn], axis=1)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--S3DIS_PATH', default='datasets/s3dis_formatted')
