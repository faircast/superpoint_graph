...
def get_datasets(args, test_seed_offset=0):
    ...
    testset  = ['formatted/' + f for f in os.listdir(args.CUSTOM_SET_PATH + '/superpoint_graphs/formatted')]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--CUSTOM_SET_PATH', default='datasets/onerd_formatted')
