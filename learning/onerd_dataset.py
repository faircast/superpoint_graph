...
Script to create a formatted dataset from preprocessed spg features and get informations about itThis script is formatted to preprocess the one_room dataset features from spg
"""
